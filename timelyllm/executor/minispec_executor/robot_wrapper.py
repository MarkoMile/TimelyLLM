...
class RobotObservation(ABC):
    ...
    def update_observation(self):
        ...
        print(f"[{self.robot_info.robot_id}] Starting observation thread with interval {self.interval:.2f} seconds.")
        ...
        async def schedule_tasks():
            ...
            while self.running:
                ...
                if self._image is not None:
                    ...
                    print(f"[{self.robot_info.robot_id}] Warning: No image available for processing.")
